...
export class RecipeService {
        ...
        generationConfig: {
          ...
          responseJsonSchema: {
            ...
            properties: {
              ...
              instructions: {
                type: 'string',
                description: 'Full instructions for preparing the recipe.',
              },
              ingredients: {
                type: 'array',
                ...
                items: {
                  ...
                  properties: {
                    ...
                    measure: {
                      type: 'string',
                      description:
                        'Measurement of the ingredient, including units.',
                    },
                  },
  ...
  private buildPrompt(toml: string): string {
    return [
      ...
      'Return the recipe in raw JSON with the following structure: { name: string; instructions: string; ingredients: { name: string; measure: string; }[]; }',
