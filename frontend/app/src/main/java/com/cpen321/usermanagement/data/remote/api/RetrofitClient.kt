...
object RetrofitClient {
    ...
    val foodItemInterface: FoodItemInterface = retrofit.create(FoodItemInterface::class.java)
    val foodTypeInterface: FoodTypeInterface = retrofit.create(FoodTypeInterface::class.java)
